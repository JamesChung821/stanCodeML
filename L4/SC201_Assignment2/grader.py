...
File: grader.py
-----------------------------
Milestone 4 answer: TODO: train error is reduced as numEpochs increases
numEpochs = 40 train error = 0.03601575689364097, validation error = 0.26730444569499157
numEpochs = 70 train error = 0.014631401238041642, validation error = 0.26139561057962857
numEpochs = 80 train error = 0.012380416432189083, validation error = 0.263083849184018
numEpochs = 90 train error = 0.009566685424873381, validation error = 0.2658975801913337
"""
...
grader.add_basic_part('4a-2', test4a2, max_points=30, max_seconds=140, description="test classifier on real polarity dev dataset")
...
# TODO: extractWordFeatures has less weights, 11622 weights, converging slowly with train error = 0.03601575689364097, validation error = 0.26730444569499157.
# TODO: extractCharacterFeatures has more weights, 49209 weights, converging faster with train error = 0.0, so it has a little overfitting with higher validation error = 0.27687113111986494.
############################################################
