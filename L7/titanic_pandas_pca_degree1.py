...
def main():
	...
	pca = decomposition.PCA(n_components=5)		# New code
	x_train = pca.fit_transform(x_train)
	print('Var Retain:', sum(pca.explained_variance_ratio_))
	...
	x_test = pca.transform(x_test)		# New code

	# Predict
	predictions = classifier.predict(x_test)
	# out_file(predictions, 'pandas_submission_pca_degree1.csv')
